...
const companies = [
  {
    ...
    logo: { src: '/images/testimonials/cardano-foundation.svg', width: 200, height: 54 },
    href: 'https://cardanofoundation.org',
  },
  {
    name: 'Sundae Labs',
    logo: { src: '/images/testimonials/sundae-labs.svg', width: 200, height: 35 },
  ...
  return (
    ...
    <section className="container">
      <div className="bordered-div-padding relative border border-t-0 border-[#31a2d8]">
        ...
        {/* Company logos */}
        <Marquee className="mt-6 [--gap:4rem] md:mt-8 lg:mt-10 xl:[&_div]:[animation-play-state:paused] invert" repeat={1}>
          {companies.map((company) => (
            ...
            >
              <img
                ...
                style={company.applyFilter ? {filter: "brightness(0) invert(calc(1 - var(--logo-invert)))" }: {filter: "invert(var(--logo-invert))"}}
              />
            </a>
          ))}
        </Marquee>
