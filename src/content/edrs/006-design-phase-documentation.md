...
- Bug bounty: create an incentive to generate traffic on the testnet preprod and bring contributors to the project
  > _Testnet developer bounty:_ Create on preprod the use cases defined by the Amaru team by building the transactions on the network and generate the conditions needed  
  > _Testnet SPO bounty:_ Produce a block that includes the above use case  
  > _Amaru development bounty:_ be involved in at least 3 contributions accepted by maintainers
